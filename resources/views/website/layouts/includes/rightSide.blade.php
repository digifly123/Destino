<div class="col-12 col-xxl-3 p-0">
    ...
    <div class="p-3 h-100 mt-4">
        <div class="d-flex align-items-center mb-4">
            <img src="images/girl.png" class="rounded-circle wpx-50 hpx-50" alt="" />
            <div class="ms-2">
                <h2 class="fs-5 m-0 fw-bold text-capitalize">omar ahmed</h2>
                <span class="fs-8 gray">omar.ahmed@gmail.com</span>
            </div>
        </div>
